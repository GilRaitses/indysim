...
An analytic hazard kernel for optogenetically-driven larval
...
Extension to a \(2\times2\) factorial design with 12 experiments, 623
tracks, and 7,288 events reveals conserved kernel shape alongside
...
turns/min. The hazard model framework provides a starting point for
